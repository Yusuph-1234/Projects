...
function initCurrentProjectInWorkspaceRootFsPath(currentDocument) {
    if (monoRepoSupport) {
        ...
        var projectFolder = projectService_1.findFirstRootProjectFile(rootPath, vscode_uri_1.URI.parse(currentDocument).fsPath);
...
connection.onDefinition((handler) => {
    ...
    const provider = new definitionProvider_1.SolidityDefinitionProvider(projectRootPath, packageDefaultDependenciesDirectory, packageDefaultDependenciesContractsDirectory, remappings);
